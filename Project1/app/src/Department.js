...
class Department extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            DepartmentId: 0,
            DepartmentName: "",
            Btntype: 0, // [0 : CreateBtn , 1 : UpdateBtn]
            DepartmentIdFilter: "",
    ...
    FilterFn() {
        ...
        console.log('Id : ' , DepartmentIdFilter)
        var DepartmentNameFilter = this.state.DepartmentNameFilter;
        console.log('Name : ' , DepartmentNameFilter)
    ...
    changeDepartmentIdFilter = (e) =>{
        console.log('Enter changeDepartmentIdFilter')
        this.state.DepartmentIdFilter=e.target.value;
        this.FilterFn();
    }

    changeDepartmentNameFilter = (e) =>{
        console.log('Enter changeDepartmentNameFilter')
    ...
    render() {
        const { departments, modalTitle, DepartmentId, DepartmentName, Btntype } = this.state
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="text" className="form-control" value={DepartmentId} onChange={this.changeDepartmentId} />
                                    <span className="input-group-text">DepartmentName</span>
                                    <input type="text" className="form-control" value={DepartmentName} onChange={this.changeDepartmentName} />
                                </div>
                                {Btntype === 0 ? <button type="button" className="btn btn-primary float-start" onClick={() => this.createClick()}>Create</button> : null}
                                {Btntype === 1 ? <button type="button" className="btn btn-primary float-start" onClick={() => this.updateClick()}>Update</button> : null}
                            </div>
                        </div>
                    </div>
                </div>
